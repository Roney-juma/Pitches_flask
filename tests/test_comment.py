...
class CommentModelTest(unittest.TestCase):
  def setUp(self):
    self.user_Hassan = User(username = 'Roney',password = '123456', email = 'juma@gmail.com')
    self.new_pitch = Pitch(pitch_title='Supermarket',pitch_body='This is a pitch about my new supermarket',pitch_category="Investors",user = self.user_Roney )
